...
<div class="container">
  ...
  <div class="row">
	<form class="form-horizontal panel-body"  action="posting.php" method="post"  enctype="multipart/form-data">
	...
	<div class="form-group">
			...
			<div class="col-lg-6"><textarea class="form-control" name="story" id="story" rows="20" required></textarea></div>
...
<?php
 ...
 if(isset($_POST["name"])){
	...
	$time = date('h:i:sa');
	$cat = preg_replace('#[^ a-zA-Z0-9!]#i','',$_POST['cat']);
	$story = $_POST['story'];
	$title = preg_replace('#[^ a-zA-Z0-9!?.]#i','',$_POST['title']);
	$university = preg_replace('#[^ a-zA-Z0-9!?.]#i','',$_POST['university']);
